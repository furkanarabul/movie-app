  ...
  methods: {
    addToList: async function (e) {
      const sendData = await axios.post(
        `https://movie-d6b-default-rtdb.firebaseio.com/movieList/.json`,
        {
    ...
    getMovieFromDB: async function (key) {
      const response = await axios.get(
        `https://movie-d6b-default-rtdb.firebaseio.com/movieList/${key}/.json`
      );
    ...
    updateMovieRating: async function (rating) {
      const response = await axios.patch(
        "https://movie-d6b-default-rtdb.firebaseio.com/movieList/" +
          this.$route.params.firebaseKey +
          ".json",
        { rating: this.rating }
      );
